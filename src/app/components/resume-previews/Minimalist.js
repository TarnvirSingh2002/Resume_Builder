    ...
    <div style={styles.wrapper}>
      ...
      <div ref={resumeRef} style={styles.page}>
        ...
        <div>
          ...
          <p style={styles.contactText}>{capitalize(location)}</p>
        ...
        <Section title="EDUCATION">
          {education.map((edu, idx) => (
            <div key={idx} style={styles.row}>
              ...
              <p style={styles.muted}>{edu?.degree?capitalize(edu.degree):""}</p>
              <p style={styles.muted}>{edu?.location?capitalize(edu.location):""}</p>
        ...
        <Section title="EXPERIENCE">
          {experience.map((exp, idx) => (
            <div key={idx} style={styles.row}>
              ...
              <p style={styles.muted}>{exp?.role?capitalize(exp.role):""}</p>
              <p style={styles.muted}>{exp?.location?capitalize(exp.location):""}</p>
